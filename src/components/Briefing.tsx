    ...
    >
      ...
      <aside className="ei-sidebar">
        ...
        <nav className="ei-sidebar-nav">
          ...
          <button className="ei-sidebar-link coming-soon">
            <Play size={16} />
            Simulations
          </button>
          <button className="ei-sidebar-link active">
            <FileText size={16} />
            Case Files
          </button>
          <button className="ei-sidebar-link coming-soon">
        ...
        <div className="ei-sidebar-footer">
          <button
            className="btn-gold"
            onClick={resetGame}
            style={{ width: "100%", fontSize: 12, padding: "10px 14px", gap: 8 }}
          >
            <Plus size={14} />
            New Simulation
          </button>
      ...
      <div className="flex-1 flex flex-col min-w-0 h-full">
        ...
        <div className="flex-1 overflow-y-auto">
          <div className="w-full px-6 sm:px-10 py-6 sm:py-8 mx-auto" style={{ maxWidth: 1060 }}>
            ...
            >
              ...
              >
                Case ID: #SIM-{caseId} &bull; Difficulty: {diff.label}
              </p>
            </motion.div>
                ...
                <div className="flex items-start gap-5 mb-5">
                  ...
                  <div className="flex-1 min-w-0" style={{ paddingTop: 8 }}>
                    ...
                    <p style={{ fontSize: 13, color: "var(--text-secondary)" }}>
                      {sc.customer.age}, {sc.customer.city} &bull; {sc.customer.profession}
                    </p>
                  </div>
                </div>
